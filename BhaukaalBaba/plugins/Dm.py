        ...
        if len(Mighty) == 2:
            ...
            if int(g) in MightyX1:
                ...
                await e.reply(text, parse_mode=None, link_preview=None )
                 ...
                 await e.reply("Message Delivered by kaalspam ✅")
    ...
    if e.sender_id in SUDO_USERS:
        ...
        if len(Mighty) == 2:
            ...
            if int(g) in MightyX1:
                ...
                await e.reply("Dm Raid Started Successfully by kaalspam!! ✅")
            ...
            if int(g) in MightyX1:
                ...
                counter = int(Mighty[0])
                await e.reply("Dm Raid Strated Successfully by kaalspam!! ✅")
                for _ in range(counter):
                    reply = random.choice(RAID)
                    caption = f"{reply}"
                    async with e.client.action(g, "typing"):
